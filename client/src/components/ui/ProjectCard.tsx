  ...
  return (
    <div
      className={`
        ...
        hover:shadow-[0_8px_40px_#00FFB210]
        hover:-translate-y-1
        ${isFeatured ? "p-7" : "p-5"}
      `}
    >
      ...
      <div className="flex items-start justify-between gap-4">
        ...
        {/* External links — GitHub and Live URL */}
      ...
      {/* ── Project Title ───────────────────────────────────────── */}
      <h3
       className={`font-display font-bold transition-colors duration-200 ${isFeatured ? 'text-xl' : 'text-lg'}`}
